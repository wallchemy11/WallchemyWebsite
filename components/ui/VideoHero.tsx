    ...
    <section className="relative min-h-[62svh] overflow-hidden sm:min-h-[68svh] md:min-h-[90vh]">
      ...
      <div className="relative z-10 mx-auto flex min-h-[62svh] max-w-6xl flex-col justify-end px-6 pb-12 sm:min-h-[68svh] sm:pb-14 md:min-h-[90vh] md:pb-24">
        <HeroReveal>
          <h1
            data-hero
            className="font-display text-[1.9rem] font-semibold uppercase tracking-[0.13em] sm:text-4xl sm:tracking-[0.18em] md:text-7xl md:tracking-[0.2em]"
          >
            {headline}
          </h1>
          {subheadline ? (
            <p
              data-hero
              className="mt-4 max-w-3xl text-[11px] uppercase tracking-[0.14em] text-alabaster/70 sm:mt-5 sm:text-sm sm:tracking-[0.2em] md:text-base md:tracking-[0.24em]"
            >
              {subheadline}
            </p>
          ) : null}
